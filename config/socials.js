// ============================================================
//  config/socials.js  ← THE ONLY FILE YOU EDIT
// ============================================================
const BLIPBOX_CONFIG = {

  // -- emailjs (emailjs.com — free) -------------------------
  emailjs: {
    publicKey:  'ZrZDs1KOG2AvAfoQU',   // Account → Public Key
    serviceId:  'service_jo2laxr',           // Email Services → Service ID
    templateId: 'template_bgoutxr',          // Email Templates → Template ID
  },

  // -- imgbb (imgbb.com — free, for drawings) ---------------
  imgbb: {
  ...
  links: {
    ...
    youtube: '',
    roblox:  'https://www.roblox.com/users/525456810/profile',
    github:  '',
  },
